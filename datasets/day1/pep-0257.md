...
methods (including the __init__
constructor) should also have
...
around
docstrings. Use r"""raw triple double quotes"""
if you use any
...
on a line by themselves. This way, Emacs’ fill-paragraph
command
can be used on it.
